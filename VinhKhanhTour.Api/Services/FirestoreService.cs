...
public class FirestoreService
{
    ...
    public async Task SyncGlobalStatsAsync()
    {
        ...
        long totalPlay = history.Count(h => string.Equals(h.Action, "play_audio", System.StringComparison.OrdinalIgnoreCase) || string.Equals(h.Action, "poi_play", System.StringComparison.OrdinalIgnoreCase));
